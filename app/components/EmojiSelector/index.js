...
const emojiStandard = emoji.filter(e => (parseFloat(e.added_in) < 7.0 && e.has_img_messenger));
const emojiByCategory = category => emojiStandard.filter(e => e.category === category);
